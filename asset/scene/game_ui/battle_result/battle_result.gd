...
onready var _title_label = $VBoxContainer/Label

onready var _player_name_label = $VBoxContainer/HBoxContainer2/PanelContainer/VBoxContainer/Label
onready var _player_list_squad_container = $VBoxContainer/HBoxContainer2/PanelContainer/VBoxContainer/ScrollContainer/GridContainer

onready var _bot_name_label = $VBoxContainer/HBoxContainer2/PanelContainer2/VBoxContainer2/Label2
onready var _bot_list_squad_container = $VBoxContainer/HBoxContainer2/PanelContainer2/VBoxContainer2/ScrollContainer2/GridContainer
...
func set_battle_data(text_result, battle_data):
